...
const pigLatin = () => {
  ...
  let str = inputElement.value.toLowerCase()
  console.log(str)
  if (vowels.includes(str[0])){
  
  return outputElement.innerText = str + ending
  }
  // now we create the part of the function where if the word starts with a consonant; save the consonants and find the first vowel//
   ...
   return outputElement.innerText = str.substring(consonants.length) + consonants + ending2;
  }
